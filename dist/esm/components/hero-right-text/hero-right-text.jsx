        ...
        return __generator(this, function (_b) {
            ...
            <div className={"".concat(ts(effectiveTheme, "innerContainerStyle"))}>
                ...
                <div className={"".concat(ts(effectiveTheme, "contentContainerStyle"))}>
                    ...
                    {block.callToActions.map(function (cta, i) { return (<a key={"hero-right-text-".concat(rowIndex, "-").concat(componentIndex, "-cta-").concat(i)} rel="noopener noreferrer" href={t(cta.ctaUrl).__html} className={"".concat(tsi(effectiveTheme, "ctaButtonStyle", i))}>
