...
export function HeroTwoImpl(props) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_o) {
            ...
            {backgrounds}
            <div className={"".concat(ts(effectiveTheme, "containerStyle"), " ").concat((_a = effectiveTheme.containerStyle) === null || _a === void 0 ? void 0 : _a.base, " ").concat((_b = effectiveTheme.containerStyle) === null || _b === void 0 ? void 0 : _b.decoration)}>
