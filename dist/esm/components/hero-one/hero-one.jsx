    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            <div className={"".concat(ts(effectiveTheme, "innerContainerStyle"))}>
                ...
                <div key={"hero-one-".concat(rowIndex, "-").concat(componentIndex, "-cta-container")} className={"".concat(ts(effectiveTheme, "ctaContainerStyle"))}>
                    {block.callToActions.map(function (cta, i) { return (<a key={"hero-one-".concat(rowIndex, "-").concat(componentIndex, "-cta-").concat(i)} href={t(cta.ctaUrl).__html}>
